...
<body>
	<div class="container">
		...
		<form ACTION="AddPromoServlet" id="addPromoForm">
			<fieldset>
				<legend style="width:auto;">Add a Promotion & email all subscribers</legend>
				* Promo Code: <input name="promoCode" id="promoCode" value="" required><br />
				* Discount %: <input type="number" step="000." name="discount" id="discount" value="" required><br />
				* Expiration Date: <input type="date" name="date" id="date" value="" required><br />

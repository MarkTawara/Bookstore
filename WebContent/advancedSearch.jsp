	...
	<div class="container">
		...
		<div class="adSearchDiv">
			...
			<div class="adSearchField">
				<form action="SearchBooksServlet">
					<input type="hidden" name="type" value="advSearch">
					<div class="asblock">
						<label class="asLabel">Book Title: </label> <input
							class="asInputField" type="text" name="title" value="">
					</div>
					<div class="asblock">
						<label class="asLabel">Author: </label> <input
							class="asInputField" type="text" name="author" value="">
					</div>
					<div class="asblock">
